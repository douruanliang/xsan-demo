	...
	*/
	...
	Tree.prototype.buildStyle = function () {
		...
		if (this.options.onhoverColor) {
			...
			'}';
			style += '.node-' + this.elementId + ':not(.node-disabled):hover div .tree-actions{'+
			    'display:block;'+
			'}';
		}
	...
	Tree.prototype.template = {
		list: '<ul class="list-group" style="margin:0 auto;" ></ul>',
		item: '<li class="list-group-item"></li>',
		indent: '<span class="indent"></span>',
		icon: '<span class="icon"></span>',
		link: '<a href="#" style="color:inherit;"></a>',
		badge: '<span class="badge">tag</span>'
	};

	Tree.prototype.css = '.treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:8px;margin-right:8px}.treeview span.icon{width:12px;margin-right:5px}.treeview .node-disabled{color:silver;cursor:not-allowed}'
